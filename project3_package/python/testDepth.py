...
# --------------------  Display
plt.figure()
plt.imshow(dispM_rectified * (rectIL > 40), cmap='gray')
plt.axis('image')
plt.title('Disparity Map rectified')
plt.savefig('../results/disparity_rectified.png', dpi=300)
plt.close()

plt.figure()
plt.imshow(depthM_rectified * (rectIL > 40), cmap='gray')
plt.axis('image')
plt.title('Depth Map rectified')
plt.savefig('../results/depth_rectified.png', dpi=300)
